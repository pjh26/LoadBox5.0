...
class MainApp(App):
	...
	# def build(self):
		...
		# presentation = ScreenManager(transition = NoTransition())
		# presentation.add_widget(HomeScreen(name='home'))
		# presentation.add_widget(ChooseProgScreen(name='chooseprog'))
		# presentation.add_widget(SwitchScreen(name='switch'))
		# presentation.add_widget(NewProgScreen0(name='newprog'))
		# presentation.add_widget(NewProgScreen1(name='editprog'))
		# return presentation
